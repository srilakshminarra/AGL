...
public class owner
{
  ...
  public static  Pair<ArrayList, ArrayList> Catarray()
			  ...
			  arr.remove(2);
	           //Looping through the data to pets array
					...
					/*  System.out.println("Male\n");      // Printing out the list values
					  ...
					  return ImmutablePair.of(Mlist, Flist);  
...
public static void main(String[] args) throws Exception{
	...
	Pair<ArrayList, ArrayList> pair = Catarray();
	 System.out.println("Male\n");
	  pair.getLeft().forEach(System.out::println); 
	  System.out.println("Female\n");// gets you the first array list
	  pair.getRight().forEach(System.out::println); // gets you the second array list
